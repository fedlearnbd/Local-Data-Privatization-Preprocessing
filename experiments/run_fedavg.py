...
MODEL_SAVE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "results", "models", "fedavg"))

METRICS_SAVE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "results", "metrics", "fedavg"))

PLOTS_SAVE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "results", "plots", "fedavg"))
...
print(f"Federated Learning with FedAvg")
