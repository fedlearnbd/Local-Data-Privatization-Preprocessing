...
global_model_path="results/models/fedavg/final_model_for_dataset_"+args.dataset+"_num_rounds_"+str(args.rounds)+".keras"
 
global_model = load_global_model(global_model_path)

csv_dir = f"results/attacks/mia/fedavg/{args.dataset}/test.csv";
