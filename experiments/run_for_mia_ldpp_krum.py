...
parser = argparse.ArgumentParser(description="Run Federated Learning with FedKrum.")
...
global_model_path=f"results/models/ldpp-krum/final_model_for_dataset_{args.dataset}_num_rounds_{args.rounds}_{args.transform}_{args.noise}_{args.epsilon}.keras"
 
global_model = load_global_model(global_model_path)

csv_dir = f"results/attacks/mia/ldpp-krum/{args.dataset}_num_rounds_{args.rounds}_{args.transform}_{args.noise}_{args.epsilon}/test.csv"
