...
MODEL_SAVE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "results", "models", "ldpp-krum"))

METRICS_SAVE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "results", "metrics", "ldpp-krum"))

PLOTS_SAVE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "results", "plots", "ldpp-krum"))
...
print(f"Federated Learning with Ldpp-krum")
