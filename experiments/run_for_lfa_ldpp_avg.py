...
parser = argparse.ArgumentParser(description="Run Federated Learning with Ldpp-avg.")
...
model_path = f'results/models/ldpp-avg/lfa_attacks/final_model_dataset_{args.dataset}_num_rounds_{args.rounds}_advers_ratio_{args.attacker_ratio}.keras'
...
metric_path = f'results/metrics/ldpp-avg/lfa_attacks/metrics_{args.dataset}_rnds_{args.rounds}_ratio_{args.attacker_ratio}.csv'
...
graph_path=f'results/metrics/ldpp-avg/lfa_attacks/graph_{args.dataset}_rnds_{args.rounds}_ratio_{args.attacker_ratio}.csv'
